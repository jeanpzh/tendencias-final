...
\fbox{\parbox{0.90\columnwidth}{\centering\footnotesize
\textbf{Inclusión} (n=18 estudios finales)
}}
...
La frecuencia total (18) corresponde al número de estudios incluidos; algunos estudios emplean más de un instrumento de evaluación.
...
La Tabla~\ref{tab:estudios} resume los 18 estudios incluidos. Los nombres de autores se presentan como texto descriptivo para facilitar la lectura; la referencia completa se encuentra en la sección de Bibliografía. La tabla completa se presenta en el Apéndice~\ref{app:estudios}.
...
A partir de la síntesis de los 18 estudios incluidos, se identificaron siete vacíos críticos de investigación que requieren atención prioritaria en futuras investigaciones:
...
\begin{enumerate}[leftmargin=*, labelsep=5pt, itemsep=2pt]
    ...
    \item \textbf{Miopía cultural:} Existe una sobre-representación significativa de demografías occidentales en la muestra de estudios revisados \cite{folstad2021, mehra2024}. La validación de instrumentos de evaluación en contextos culturales diversos, particularmente en América Latina, Asia y África, es esencial para garantizar la aplicabilidad global de los hallazgos.
...
La Tabla~\ref{tab:estudios} presenta el resumen completo de los 18 estudios incluidos en la revisión sistemática.
