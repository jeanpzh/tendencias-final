...
{\large\textbf{Kenny Danny Martínez Fuentes$^{1}$,\\[4pt]
Christian Angelo Guerrero Falla$^{1}$,\\[4pt]
Jose Luis Vergara Pachas$^{1}$,\\[4pt]
JeanPierre D'Angelo Motta Chumbe$^{1}$,\\[4pt]
Felipe Triveño Daza$^{1}$,\\[4pt]
