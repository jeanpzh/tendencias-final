...
The massive adoption of conversational agents powered by artificial intelligence has transformed human-computer interaction. This systematic literature review analyzes methodologies, instruments, and metrics used to evaluate UX in conversational agents. The PRISMA protocol was followed, searching Scopus, IEEE Xplore, Springer, MDPI, BMC, and JMIR for 2021--2026. Of 347 initial results, 18 studies met all criteria. Findings reveal a transition from generic usability scales to native instruments like the Chatbot Usability Scale (BUS).
\vspace{0.3cm}
...
\midrule
Følstad et al. (2021) & General & Revisión & Agenda de investigación para chatbots \\
Kuhail et al. (2022) & Educación & Revisión & 36 papers; chatbots como tutores web \\
...
Wang y Lo (2025) & General & Experimental & Latencia influye según la edad \\
Brdnik et al. (2022) & General & Mapping & Interfaces inteligentes evaluadas \\
Jannach (2022) & Sistemas de recomendación & Revisión & Evaluación de recomendadores \\
Borsci et al. (2022) & General & BUS-11 & Validación multilingüe; 11 ítems \\
He et al. (2022) & Salud & Experimento & Chatbot entrevista motivacional \\
Bielawski (2022) & General & Mapping & Métodos HCII: sensores e IA \\
Roick y Jansen (2023) & Salud & Experimento & Chatbot motivacional iterativo \\
Fan et al. (2023) & Salud & Logs & Uso real chatbots autodiagnóstico \\
Chung et al. (2021) & Salud & Usability & Chatbot perinatal Q\&A \\
Mariamo et al. (2021) & Salud & Experimental & Reacciones adolescentes \\
Chou et al. (2024) & Salud & Usability & Chatbot adultos mayores COVID \\
Mehra (2024) & General & Experimental & Personalidad en chatbots \\
Thunström et al. (2024) & Salud & RCT & Humano digital vs. chatbot texto \\
\bottomrule
\end{tabular}
\end{table*}
