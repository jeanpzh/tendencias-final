...
- Name: edge-cases.spec.ts >> Page responsiveness (not hung) >> form request doesn't freeze the page
- Location: e2e/edge-cases.spec.ts:35:7

# Error details

```
Error: page.goto: net::ERR_CONNECTION_REFUSED at http://localhost:3000/demo/form-builder
Call log:
  - navigating to "http://localhost:3000/demo/form-builder", waiting until "load"
