  ...
  return (
    <TooltipProvider>
      <div className="h-dvh flex flex-col bg-background">
        {/* Header */}
        <header className="h-12 sm:h-14 border-b shrink-0 bg-card/80 backdrop-blur-md flex items-center">
          <div className="w-full mx-auto px-4 flex items-center justify-between">
            <div className="flex items-center gap-3">
              ...
              <div className="flex items-center gap-2">
                <div
                  className={`h-8 w-8 rounded-lg bg-gradient-to-br ${demo.color} flex items-center justify-center shadow-sm`}
                >
                  <Sparkles className="h-4 w-4 text-white" />
                </div>
                <div className="hidden sm:block">
                  <h1 className="font-semibold text-sm leading-tight">{demo.title}</h1>
            ...
            {/* Right side: model selector + usage */}
            <div className="flex items-center gap-2">
              <ApiUsage />
